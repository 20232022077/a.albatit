                        ...
                        <td class="p-4 whitespace-nowrap">
                            ...
                            @else
                                ...
                                @can('permission', 'content.delete')
                                    <form class="inline" method="POST" action="{{ route('admin.quraniyat.destroy', $item) }}" data-confirm="حذف هذا المحتوى؟">@csrf @method('DELETE')<button class="mr-3 text-red-700">حذف</button></form>
                                @endcan
                            @endif
                        </td>
                    </tr>
