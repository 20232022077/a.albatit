...
<main class="mx-auto max-w-6xl px-5 py-12">
    <h1 class="text-3xl font-bold">المحاضرات</h1>
    ...
    <div class="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        @forelse($items as $item)
            <a href="{{ route('lectures.show', $item->slug) }}" class="block overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition hover:shadow-md">
